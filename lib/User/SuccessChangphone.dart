...
class SuccessChangePhone extends StatefulWidget {
  @override
  _SuccessChangePhoneState createState() => _SuccessChangePhoneState();
}

class _SuccessChangePhoneState extends State<SuccessChangePhone> {
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: const Color.fromARGB(255, 92, 116, 250), // Set button color here
                ),
                child: Text(
                  'เสร็จสิ้น',
                  style: TextStyle(
